...
@Autonomous(name = "BlueSampleAuto0_7Test")
public class BlueSampleAuto0_7 extends PedroOpMode {
    public BlueSampleAuto0_7() {
        ...
        new SequentialGroup(
                ...
                new ParallelGroup(
                        new SequentialGroup(
                                new Delay(0.1),
                                new InstantCommand(() -> {
                                    Sample.INSTANCE.right_shoulder.setPosition(0.01);
                                    Sample.INSTANCE.left_shoulder.setPosition(0.01);
                                    Sample.INSTANCE.elbow.setPosition(0.5);
                                    turret.INSTANCE.resetTurret();
                                    Slides.INSTANCE.resetVert();
                                }),
                                new Delay(0.4),
                                new InstantCommand(() -> {
                                    Sample.INSTANCE.left_shoulder.setPosition(0.35);
                                    Sample.INSTANCE.right_shoulder.setPosition(0.35);
                                    Sample.INSTANCE.elbow.setPosition(0.02);
                                })
                        ),
                ...
                new InstantCommand(() -> {
                    ...
                    Sample.INSTANCE.elbow.setPosition(0.1);
                }),
                new Delay(0.1),
                new InstantCommand(() -> claw.INSTANCE.finger.setPosition(0.0)),
                new Delay(0.3),
                new ParallelGroup(
                        new FollowPath(pickUp1ToCorner,true),
                        new SequentialGroup(
                                new InstantCommand(() -> Specimen.INSTANCE.resetArm()),
                                new InstantCommand(() -> Slides.INSTANCE.extendVert()),
                                new InstantCommand(() -> turret.INSTANCE.spinTurretAuto()),
                                new Delay(0.7),
                                new InstantCommand(() -> Sample.INSTANCE.basketDepositTefdafe())
                        )
                ),
                new Delay(0.25),
                claw.INSTANCE.openClaw(),
                ...
                new Delay(0.3),
                new ParallelGroup(
                        new FollowPath(pickUp2toCorner,true),
                        new SequentialGroup(
                                new InstantCommand(() -> Specimen.INSTANCE.resetArm()),
                                new InstantCommand(() -> Slides.INSTANCE.extendVert()),
                                new InstantCommand(() -> turret.INSTANCE.spinTurretAuto()),
                ...
                new ParallelGroup(
                        new SequentialGroup(
                                ...
                                new InstantCommand(() -> {
                                    ...
                                    Sample.INSTANCE.left_shoulder.setPosition(0.01);
                                    Sample.INSTANCE.elbow.setPosition(0.5);
                                    Sample.INSTANCE.wristMiddle();
                                    Slides.INSTANCE.resetVert();
                                    turret.INSTANCE.spinTurretThird();
                                }),
                                new Delay(0.6),
                                new InstantCommand(() -> {
                                    Sample.INSTANCE.left_shoulder.setPosition(0.35);
                                    Sample.INSTANCE.right_shoulder.setPosition(0.35);
                                    Sample.INSTANCE.elbow.setPosition(0.02);
                                    Sample.INSTANCE.wrist.setPosition(((90+20)/257.14)+0.17);
                                })
                        ),
                        new FollowPath(cornerToPickUp3,true)
                ),
                new InstantCommand(() -> {
                    Sample.INSTANCE.left_shoulder.setPosition(0.4);
                    Sample.INSTANCE.right_shoulder.setPosition(0.4);
                ...
                new Delay(0.3),
                new ParallelGroup(
                        new FollowPath(pickUp3ToCorner,true),
                        new SequentialGroup(
                                new Delay(0.3),
                                new InstantCommand(() -> Specimen.INSTANCE.resetArm()),
                                new InstantCommand(() -> Slides.INSTANCE.extendVert()),
